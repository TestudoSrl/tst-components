...
import { ralColors } from './colors';

export const updateColorMap = async () => {
...
// export const updateColorMapEPaint = async () => {
//     const targetUrl = 'https://www.e-paint.co.uk/lab-hlc-rgb-lrv-values.asp?cRange=RAL+Classic&cRef=';
//     const proxyUrl = 'https://cors-anywhere.herokuapp.com/';

//     const colorDetails: ColorDetails[] = [];

//     const colorToProcess = ralColors.filter(c => c.name === 'RAL 1000');
//     for await (const color of colorToProcess) {

//         const urlWithColor = targetUrl + color.name.replace(' ', '+');
//         console.log("Processing URL: " + urlWithColor);

//         //wait 10 seconds before each request
//         await new Promise((resolve) => setTimeout(resolve, 500));

//         const response = await fetch(proxyUrl + urlWithColor, {
//             headers: {
//                 origin: 'https://www.e-paint.co.uk/',
//                 // or
