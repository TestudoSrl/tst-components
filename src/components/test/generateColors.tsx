...
export const updateColorMapRal = async () => {
    ...
    if (response.status !== 200) {
      ...
      linkC.setAttribute(
        ...
        'data:text/plain;charset=utf-8,' +
          encodeURIComponent(JSON.stringify({ correctedColors, processedCoror: processedColor }, null, 2)),
      );
  ...
  link.setAttribute(
    'href',
    'data:text/plain;charset=utf-8,' + encodeURIComponent(JSON.stringify({ correctedColors }, null, 2)),
  );
...
export const updateAllColors = async () => {
  ...
  link.setAttribute(
    ...
    'data:text/plain;charset=utf-8,' +
      encodeURIComponent(
        JSON.stringify(
          { ralColors: ralColorsWithLab, ralDesignColors: ralDesignColorsWithLab, ncsColors: ncsColorsWithLab },
          null,
          2,
        ),
      ),
